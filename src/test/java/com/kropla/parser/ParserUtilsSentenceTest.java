...
public class ParserUtilsSentenceTest {
    ...
    private static final String LINE_WITH_DOT_END = "Kropla Markets is the leading international capital markets.";
    ...
    public void retrieveSentenceFromStringEndingWithDotTest(){
        ...
        List<String> sentences = Arrays.asList("Kropla Markets is the leading international capital markets");
