...
public class ParserUtilsWordTest {
    ...
    private static final String LONG = "Kropla Markets is the leading international capital markets operator and investment banking partner in the Nordic and Baltic Sea regions";
    ...
    public void retrieveWordsLongWholeLineTest(){
        List<String> words =  Arrays.asList("and","and","Baltic","banking","capital","in","international","investment","is","Kropla","leading","markets","Markets","Nordic","operator","partner","regions","Sea","the","the");
