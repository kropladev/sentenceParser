...
public class BufferTest {
    ...
    private static final String ONE_LINE_DOT_END = "Kropla Markets is operator and the Nordic and Baltic Sea regions.";
    private static final String ONE_LINE_DOT_END_SENTENCE = "Kropla Markets is operator and the Nordic and Baltic Sea regions";
